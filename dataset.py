...
class FinetuningDataset(Dataset):
    ...
    def __init__(self, lm=None, label_set=None, co_suffix=""):
        ...
        if label_set is not None:
            ...
            del dataset  # Clear manually to save on memory

        else:
            self.building_list, self.room_list, self.object_list = None, None, None
            self.building_list_pl, self.room_list_pl, self.object_list_pl = (
                None,
                None,
                None,
            )
